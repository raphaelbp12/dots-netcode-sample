...
#pragma warning restore 649
#endif
        [ReadOnly] public ArchetypeChunkBufferType<ProjectileSnapshotData> ghostSnapshotDataType;
        [ReadOnly] public ArchetypeChunkEntityType ghostEntityType;
        public ArchetypeChunkComponentType<LifeTimeComponent> ghostLifeTimeComponentType;
        public ArchetypeChunkComponentType<SpeedComponent> ghostSpeedComponentType;
        ...
        public void Execute(ArchetypeChunk chunk, int chunkIndex, int firstEntityIndex)
        {
            ...
            var ghostLifeTimeComponentArray = chunk.GetNativeArray(ghostLifeTimeComponentType);
            var ghostSpeedComponentArray = chunk.GetNativeArray(ghostSpeedComponentType);
            ...
            for (int entityIndex = 0; entityIndex < ghostEntityArray.Length; ++entityIndex)
            {
                ...
                var ghostLifeTimeComponent = ghostLifeTimeComponentArray[entityIndex];
                var ghostSpeedComponent = ghostSpeedComponentArray[entityIndex];
                var ghostRotation = ghostRotationArray[entityIndex];
                var ghostTranslation = ghostTranslationArray[entityIndex];
                ghostLifeTimeComponent.Value = snapshotData.GetLifeTimeComponentValue(deserializerState);
                ghostSpeedComponent.Value = snapshotData.GetSpeedComponentValue(deserializerState);
                ...
                ghostLifeTimeComponentArray[entityIndex] = ghostLifeTimeComponent;
                ghostSpeedComponentArray[entityIndex] = ghostSpeedComponent;
    ...
    protected override void OnCreate()
    {
        ...
        m_interpolatedQuery = GetEntityQuery(new EntityQueryDesc
        {
            All = new []{
                ...
                ComponentType.ReadWrite<SpeedComponent>(),
    ...
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        if (!m_predictedQuery.IsEmptyIgnoreFilter)
        {
            var updatePredictedJob = new UpdatePredictedJob
            {
                ...
                ghostSnapshotDataType = GetArchetypeChunkBufferType<ProjectileSnapshotData>(true),
                ...
                ghostLifeTimeComponentType = GetArchetypeChunkComponentType<LifeTimeComponent>(),
                ghostSpeedComponentType = GetArchetypeChunkComponentType<SpeedComponent>(),
